        ...
        private static async void ReceiveC2dAsync()
        {
            ...
            while (true)
            {
                ...
                else if (turn == 16)
                {
                    ...
                    Console.WriteLine("Left Junciton North Green Time: {0}, Priority: {1}", north1_green_time, north1_priority);
                    Console.WriteLine("Left Junciton East Green Time: {0}, Priority: {1}", east1_green_time, east1_priority);
                    Console.WriteLine("Left Junciton South Green Time: {0}, Priority: {1}", south1_green_time, south1_priority);
                    Console.WriteLine("Left Junciton West Green Time: {0}, Priority: {1}", west1_green_time, west1_priority);
                    Console.WriteLine("----------------------------");
                    Console.WriteLine("Right Junction North Green Time: {0}, Priority: {1}", north2_green_time, north2_priority);
                    Console.WriteLine("Right Junction East Green Time: {0}, Priority: {1}", east2_green_time, east2_priority);
                    Console.WriteLine("Right Junction South Green Time: {0}, Priority: {1}", south2_green_time, south2_priority);
                    Console.WriteLine("Right Junction West Green Time: {0}, Priority: {1}", west2_green_time, west2_priority);
