...
namespace InnovateTraffic
{
    public partial class Form1 : Form
    {
        ...
        private async static void SendCloudToDeviceMessageAsync(Junction junction)
        {
            ...
            //var messageString1 = JsonConvert.SerializeObject(test1);
            //var nt1 = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(messageString1));
            //nt1.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", nt1);
            ...
            //var messageString2 = JsonConvert.SerializeObject(test2);
            //var et1 = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(messageString2));
            //et1.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", et1);

            JSONEdison test3 = new JSONEdison();
            test3.Name = "SetGreenTime";
            //test3.Parameters.Add("Position", 5);
            //test3.Parameters.north_green_time = 1;
            //test3.Parameters.north_priority = 1;
            //test3.Parameters.east_green_time = 2;
            //test3.Parameters.east_priority = 2;
            //test3.Parameters.south_green_time = 3;
            //test3.Parameters.south_priority = 3;
            //test3.Parameters.west_green_time = 4;
            //test3.Parameters.west_priority = 4;
            test3.Parameters.north_green_time = junction.north_green_time;
            test3.Parameters.north_priority = junction.north_priority;
            test3.Parameters.east_green_time = junction.east_green_time;
            test3.Parameters.east_priority = junction.east_priority;
            test3.Parameters.south_green_time = junction.south_green_time;
            test3.Parameters.south_priority = junction.south_priority;
            test3.Parameters.west_green_time = junction.west_green_time;
            test3.Parameters.west_priority = junction.west_priority;

            var messageString3 = JsonConvert.SerializeObject(test3, new Newtonsoft.Json.Converters.KeyValuePairConverter());
            var st1 = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(messageString3));
            st1.Ack = DeliveryAcknowledgement.Full;
            await serviceClient.SendAsync("Edison01", st1);

            //var east_green_time = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(Convert.ToString(junction.east_green_time)));
            //east_green_time.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", east_green_time);

            //var east_priority = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(Convert.ToString(junction.east_priority)));
            //east_priority.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", east_priority);

            //var south_green_time = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(Convert.ToString(junction.south_green_time)));
            //south_green_time.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", south_green_time);

            //var south_priority = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(Convert.ToString(junction.south_priority)));
            //south_priority.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", south_priority);

            //var west_green_time = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(Convert.ToString(junction.west_green_time)));
            //west_green_time.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", west_green_time);

            //var west_priority = new Microsoft.Azure.Devices.Message(Encoding.ASCII.GetBytes(Convert.ToString(junction.west_priority)));
            //west_priority.Ack = DeliveryAcknowledgement.Full;
            //await serviceClient.SendAsync("Edison01", west_priority);
        }
    }
}
