...
//			junction.north_green_time = north_green_time;
//			junction.east_green_time = east_green_time;
//			junction.south_green_time = south_green_time;
//			junction.west_green_time = west_green_time;
...
//			junction.north_priority = north_priority;
//			junction.east_priority = east_priority;
//			junction.south_priority = south_priority;
//			junction.west_priority = west_priority;
...
//				time.east = 10;
//
//				Traffic_Mode(i2c, initial_state, EAST, time);
//			}
//
//			mode = 2;							// Return to Normal Mode
	}
